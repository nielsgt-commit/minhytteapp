...
-- fresh DB safety: with no properties yet there is nothing to attach the legacy seed rows to; drop them so NOT NULL can be applied
DELETE FROM "expense_categories" WHERE "property_id" IS NULL;--> statement-breakpoint
