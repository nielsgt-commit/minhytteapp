...
ALTER TABLE "maintenance" DROP CONSTRAINT "maintenance_routine_position_pairing";--> statement-breakpoint
ALTER TABLE "maintenance" DROP CONSTRAINT "maintenance_routine_id_routines_id_fk";
