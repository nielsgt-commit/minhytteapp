...
CREATE TABLE "rooms" (
	...
	"beds_double" integer DEFAULT 0 NOT NULL,
	"mattresses" integer DEFAULT 0 NOT NULL,
	"travel_cot" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "settlement_transfers" (
	...
	"from_user_group_id" integer NOT NULL,
	"to_user_group_id" integer NOT NULL,
	"amount" integer NOT NULL,
	"status" varchar(7) NOT NULL,
	"paid_at" timestamp,
	CONSTRAINT "transfer_distinct_parties" CHECK ("settlement_transfers"."from_user_group_id" <> "settlement_transfers"."to_user_group_id"),
...
--> statement-breakpoint
CREATE TABLE "settlement_user_group_totals" (
	"settlement_id" integer NOT NULL,
	"user_group_id" integer NOT NULL,
	"total_paid" integer NOT NULL,
	"total_share" integer NOT NULL,
	"net" integer NOT NULL,
	CONSTRAINT "settlement_user_group_totals_settlement_id_user_group_id_pk" PRIMARY KEY("settlement_id","user_group_id")
);
--> statement-breakpoint
...
ALTER TABLE "settlement_transfers" ADD CONSTRAINT "settlement_transfers_from_user_group_id_user_groups_id_fk" FOREIGN KEY ("from_user_group_id") REFERENCES "public"."user_groups"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "settlement_transfers" ADD CONSTRAINT "settlement_transfers_to_user_group_id_user_groups_id_fk" FOREIGN KEY ("to_user_group_id") REFERENCES "public"."user_groups"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "settlement_user_group_totals" ADD CONSTRAINT "settlement_user_group_totals_settlement_id_settlements_id_fk" FOREIGN KEY ("settlement_id") REFERENCES "public"."settlements"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "settlement_user_group_totals" ADD CONSTRAINT "settlement_user_group_totals_user_group_id_user_groups_id_fk" FOREIGN KEY ("user_group_id") REFERENCES "public"."user_groups"("id") ON DELETE no action ON UPDATE no action;